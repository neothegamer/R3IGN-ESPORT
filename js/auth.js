...
(function () {
  ...
  function renderNavAccount(session) {
    ...
    if (session && session.user) {
      ...
      slot.innerHTML =
        '<a href="messages.html" class="btn btn-ghost nav-message-link"' + (onMessages ? ' aria-current="page"' : '') + '><span class="nav-message-icon" aria-hidden="true">🔔</span><span>Messages</span></a>' +
    ...
    if (mobileSlot) {
      if (session && session.user) {
        ...
        mobileSlot.innerHTML =
          '<a href="messages.html" class="nav-message-link"><span class="nav-message-icon" aria-hidden="true">🔔</span><span>Messages</span></a>' +
